...
class User_model extends CI_Model
{
	...
	function get_records2($request_id)
	{
		$query = $this->db->get_where('regional_credit_volume', array('request_id' => $request_id), $this->limit, $this->offset);
		return $query->result_array();
	}
	// get by region
	...
	// get by refid
	function get_records_for_all_by_ref_id($ref_id)
	{
		$query = $this->db->get_where('region_credit_request', array('ref_id' => $ref_id), $this->limit, $this->offset);
		return $query->result_array();
	}
}
